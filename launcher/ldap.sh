...
wget -O /etc/ssl/certs/ldap-eng-vmware.pem http://engweb.eng.vmware.com/sipublic/ldap/ldap-eng-vmware.pem
# setup packages
...
BIND_POLICY     soft
pam_password_prohibit_message Please use pa-psynch2.vmware.com to change your password
__ldapconf_EOF__
fi
...
service nis stop | exit 1 ; update-rc.d nis disable | exit 1
